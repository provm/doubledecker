...
low virtualization overheads (compared to VM within VM) it offers~\cite{middleware16,vmw-docker}. 
%
Containers inside VMs enable subletting business models like \emph{derivative cloud} 
model~\cite{spotcheck, google} which is the focus of this work.
%
...
components---containers at virtual machine level and VMs at the
...
primary factors.
%
First, it would require virtual machine transparent mechanisms to
identify different containers and their memory usage behaviors.
%
Second, influencing guest OS memory management can be performed
