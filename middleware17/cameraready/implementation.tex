...
cache specifications---the storage type and \revised{weight} percentage.
...
%
\revised{
As part of the future work, we plan to evaluate different eviction policies
similar to ExTmem~\cite{extmem} and provide it as a configurable option for 
the VM-level policy controller.}
...
the entities as per their \revised{weights} to calculate their effective entitlements 
