...
%
\revised{
\deba{While deduplication of hypervisor cache itself can be easily incorporated
into \dd{}, deduplication across hypervisor cache and memory used by VMs require 
...
%cache.
%
Synergy~\cite{synergy}, a holistic deduplication techniques in virtualized systems,
...
With the a two-level storage options \dd{}, can performance of this system
to different treatment of shared and unshared pages, and is yet another
intersting direction of future work.
%
% can be 
